...
const canvas = d3.select(".canva-graph3");
...
d3.json("Cellular Structures-json.txt").then(function(graph1data) { // Corrected filename here
...
createGraph1(".canva-graph3", "Cellular Structures-json.txt");
...
const canvas = d3.select(".canva-graph4")
...
//Stratify the data for 1st graph
d3.json("Cellular Structures-IS-SC-json.txt").then(function(graph2data) { // Corrected filename here
    // Log the raw flat data to see how D3 parsed it
    ...
    // Compute the tree height.
    const dx = 18;
    const dy = width / (root.height + 2); // Use 'root' instead of 'root1' // adjust link length here
...
createGraph2(".canva-graph4", "Cellular Structures-IS-SC.txt");